...
final class Authorization
{
    private const ROUTE_PERMISSIONS = [
        ...
        ['POST', '/settings/roles', 'settings.role.manage.org'],
        ['PATCH', '/settings/roles/{id}', 'settings.role.manage.org'],
        ['DELETE', '/settings/roles/{id}', 'settings.role.manage.org'],
        ['GET', '/settings/policies', 'settings.policy.manage.org'],
        ['POST', '/settings/policies', 'settings.policy.manage.org'],
        ['PATCH', '/settings/policies/{id}', 'settings.policy.manage.org'],
        ['DELETE', '/settings/policies/{id}', 'settings.policy.manage.org'],
        ['GET', '/settings/dictionaries', 'settings.dictionary.view.org'],
        ['POST', '/settings/dictionaries', 'settings.dictionary.manage.org'],
        ['PATCH', '/settings/dictionaries/{id}', 'settings.dictionary.manage.org'],
        ['DELETE', '/settings/dictionaries/{id}', 'settings.dictionary.manage.org'],
        ['GET', '/settings/workflows', 'settings.workflow.view.org'],
        ['POST', '/settings/workflows', 'settings.workflow.manage.org'],
        ['PATCH', '/settings/workflows/{id}', 'settings.workflow.manage.org'],
        ['DELETE', '/settings/workflows/{id}', 'settings.workflow.manage.org'],
